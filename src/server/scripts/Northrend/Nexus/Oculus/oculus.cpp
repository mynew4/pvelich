...
#define GOSSIP_ITEM_DRAKES         "Так куда же мы идем?"
#define GOSSIP_ITEM_BELGARISTRASZ1 "Я хочу лететь на красном драконе."
#define GOSSIP_ITEM_BELGARISTRASZ2 "Какие способности есть у Рубинового дракона?"
#define GOSSIP_ITEM_VERDISA1       "Я хочу лететь на зеленом драконе."
#define GOSSIP_ITEM_VERDISA2       "Какие способности есть у Изумрудного дракона?"
#define GOSSIP_ITEM_ETERNOS1       "Я хочу лететь на бронзовом драконе."
#define GOSSIP_ITEM_ETERNOS2       "Какие способности есть у Янтарного дракона?"
