...
#define GOSSIP_START_EVENT  "Выводите свой народ в безопасное место, мы будем удерживать войско синих драконов."
#define GOSSIP_ITEM_1       "Хорошо, активируйте кристаллы, если мы вдруг не будем справляться."
#define GOSSIP_I_WANT_IN    "Я не в бою, отправьте меня туда сейчас!"
