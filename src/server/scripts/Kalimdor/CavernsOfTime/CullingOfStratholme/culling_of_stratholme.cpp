...
#define GOSSIP_ITEM_ARTHAS_0 "Я готов начать Очищение Стратхольма."
#define GOSSIP_ITEM_ARTHAS_1 "Да, мой принц. Мы готовы."
#define GOSSIP_ITEM_ARTHAS_2 "Мы делаем только то, что лучше для Лордерона ваше высочество."
#define GOSSIP_ITEM_ARTHAS_3 "Я готов."
#define GOSSIP_ITEM_ARTHAS_4 "За Лордерон!"
#define GOSSIP_ITEM_ARTHAS_5 "Я готов сражаться с повелителем ужаса, сэр."
...
#define GOSSIP_ITEM_CHROMIE_DISUPTOR_BACK   "Хроми, мне нужен Разбиватель чар."

#define ENTRY_CHROMIE_PART_1                26527
#define GOSSIP_ITEM_CHROMIE_START_1         "Почему я был отправлен обратно в это место?"
#define GOSSIP_ITEM_CHROMIE_START_2         "Что это за решение?"
#define GOSSIP_ITEM_CHROMIE_START_3         "Нужно вмешаться в план драконов Бесконечности?"

#define ENTRY_CHROMIE_PART_2                27915
#define GOSSIP_ITEM_CHROMIE_MIDDLE_1        "Как ты думаешь, что они задумали?"
#define GOSSIP_ITEM_CHROMIE_MIDDLE_2        "Что ты хочешь делать?"
#define GOSSIP_ITEM_CHROMIE_MIDDLE_3        "Хорошо, Хроми."
